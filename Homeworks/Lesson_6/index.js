...
// Проблема в том, что массив food является является ссылочным типом данных,
// и он объявлен в прототипе. Соответственно все экземпляры будут использовать один и тот же массив.
